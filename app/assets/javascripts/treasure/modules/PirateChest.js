var PirateChest = {
    ...
    getAuthParams: function(user){
        return {
            user_email: user.email,
            user_token: user.token,
        }  
    },
    getAuthParamsString: function(user){
        return "user_email="+user.email+"&user_token="+user.token; 
    },
    initialize: function(){
        var module = angular.module('piratechest', ['folders-module']);
