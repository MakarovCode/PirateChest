module Serket
  ...
  #
  class Configuration
    attr_accessor :private_key_path, :public_key_path, :delimiter, :format, :symmetric_algorithm, :encoding, :dummy_private_key_path, :dummy_public_key_path, :dummy_password
